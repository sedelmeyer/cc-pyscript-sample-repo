...
project = "cc-pyscript sample repo"
year = "" "2021"
...
try:
    version = release = get_distribution("cc-pyscript-sample-repo").version
except Exception:
    traceback.print_exc()
...
html_baseurl = "https://sedelmeyer.github.io/" "cc-pyscript-sample-repo/"
